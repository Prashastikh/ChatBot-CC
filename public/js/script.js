$(function () {
    ...
    var welcomeMsg = "Hello, Happy to help with your queries?<br>Choose the number corresponding to your Query.<br>";

    //This is the welcome message step
    writeBotMessage(welcomeMsg);
    //THIS STEP IS TO GET ALL CATEGORIES OF QUESTIONS
    getCategories();
